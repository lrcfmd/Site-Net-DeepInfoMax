...
if __name__ == "__main__":
    ...
    for fold in task.folds[:1]:
        ...
        dataset_to_hdf5(train_inputs,train_outputs,h5_file_name + "_DIMinference_train",args.number_of_worker_processes,fold_n,supercell,supercell_size)
        dataset_to_hdf5(test_inputs,test_outputs,h5_file_name + "_DIMinference_test",args.number_of_worker_processes,fold_n,supercell,supercell_size)        
        fold_n += 1